...
```
$ wget https://github.com/greymd/ewscli/releases/download/v1.0.3/ewscli-1.0.3-x86_64-linux.deb
$ sudo dpkg -i ewscli-*
```
...
```
$ sudo yum install https://github.com/greymd/ewscli/releases/download/v1.0.3/ewscli-1.0.3-x86_64-linux.rpm
```
...
https://github.com/greymd/ewscli/releases/download/v1.0.3/ewscli_installer-1.0.3-x86_64-windows.exe
